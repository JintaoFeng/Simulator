...
extern char T_Coarse[1000];
extern char T_Fine[1000];
extern char ExpoPlanChar[1000];
extern int g_iField;
...
extern void XYRun_Forward(Axis *pAxis);
...
extern void CounterClose(Axis *pAxis);
extern void LaserSwitch(Axis *pAxis);
