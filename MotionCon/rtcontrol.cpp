...
double DataToVol( unsigned int data)
{
	double vol;
	data=0xffff&data;
...
void ConDist()
{
	...
	{
        Machine.coarseStage.dConDist[2] = Machine.coarseStage.arrAxis[2].dConCalc + (double)Machine.coarseStage.DAOffset[2];
        Machine.coarseStage.dConDist[3] = Machine.coarseStage.arrAxis[2].dConCalc + (double)Machine.coarseStage.DAOffset[2];
	}
	//X向
    Machine.fineStage.dConDist[0] = 0.5*Machine.fineStage.arrAxis[0].dConCalc - 0.5 * (double)Machine.fineStage.arrAxis[2].dConCalc + Machine.fineStage.DAOffset[0];
    Machine.fineStage.dConDist[1] = 0.5*Machine.fineStage.arrAxis[0].dConCalc + 0.5 * (double)Machine.fineStage.arrAxis[2].dConCalc + Machine.fineStage.DAOffset[1];
	//Y向
...
void TmpDataFillIn()
{
    comData.axisStatus[0]= (int)Machine.coarseStage.arrAxis[0].axisStatus;
    comData.axisStatus[1]= (int)Machine.coarseStage.arrAxis[1].axisStatus;
    comData.axisStatus[2]= (int)Machine.coarseStage.arrAxis[2].axisStatus;
    comData.axisStatus[3]= (int)Machine.coarseStage.arrAxis[3].axisStatus;
    comData.axisStatus[4]= (int)Machine.fineStage.arrAxis[0].axisStatus;
    comData.axisStatus[5]= (int)Machine.fineStage.arrAxis[1].axisStatus;
    comData.axisStatus[6]= (int)Machine.fineStage.arrAxis[2].axisStatus;
    comData.axisStatus[7]= (int)Machine.fineStage.arrAxis[3].axisStatus;
    comData.axisStatus[8]= (int)Machine.fineStage.arrAxis[4].axisStatus;
    comData.axisStatus[9]= (int)Machine.fineStage.arrAxis[5].axisStatus;
    ...
    comData.Error[4]=Machine.fineStage.arrAxis[0].dError;
    comData.Error[5]=Machine.fineStage.arrAxis[1].dError;
    comData.Error[6]=Machine.fineStage.arrAxis[2].dError;
    comData.Error[7]=Machine.fineStage.arrAxis[3].dError;
    comData.Error[8]=Machine.fineStage.arrAxis[4].dError;
    comData.Error[9]=Machine.fineStage.arrAxis[5].dError;
    ...
    comData.motorState[0]= (int)Machine.coarseStage.arrAxis[0].flag;
    comData.motorState[1]= (int)Machine.coarseStage.arrAxis[1].flag;
    comData.motorState[2]= (int)Machine.coarseStage.arrAxis[2].flag;
    comData.motorState[3]= (int)Machine.coarseStage.arrAxis[3].flag;
    ...
    comData.iCoarseData[14] = (int)Machine.coarseStage.arrAxis[0].controllerType;
    comData.iCoarseData[15] = (int)Machine.coarseStage.arrAxis[1].controllerType;
    comData.iCoarseData[16] = (int)Machine.coarseStage.arrAxis[2].controllerType;
    comData.iCoarseData[17] = (int)Machine.coarseStage.arrAxis[3].controllerType;
...
//yht
	//粗轴状态
    comData.iCoarseData[26] = (int)Machine.coarseStage.arrAxis[0].axisStatus;
    comData.iCoarseData[27] = (int)Machine.coarseStage.arrAxis[1].axisStatus;
    comData.iCoarseData[28] = (int)Machine.coarseStage.arrAxis[2].axisStatus;
    comData.iCoarseData[29] = (int)Machine.coarseStage.arrAxis[3].axisStatus;
    ...
    comData.iCoarseData[38] = (int)Machine.coarseStage.stageStatus;
    comData.iCoarseData[39] = (int)Machine.fineStage.stageStatus;
...
void SimulaterOutput()
{
	int i; 
	for(i=0;i<4;i++)
	{
		Machine.coarseStage.arrAxis[i].dSolveMethodOne = LLCCalculate(&(Machine.coarseStage.arrAxis[i].controlObject),Machine.coarseStage.dConDist[i]);
	}
	for(i=0;i<6;i++)
	{
		Machine.fineStage.arrAxis[i].dSolveMethodOne += LLCCalculate(&(Machine.fineStage.arrAxis[i].controlObject),Machine.coarseStage.dConDist[i]);
	}
}
...
void ServoCycle_t::ServoCycle()
{
 //   while(1)
 //   {
        int i=0;
        if(Machine.connectType == TCP)
        {
    //			GetFeedBack();
    //			PosSolve();
        }
        ...
        else if(Machine.connectType == simulater)
        {
            SimulaterOutput();
        }
        Machine.iServoCnt++;
