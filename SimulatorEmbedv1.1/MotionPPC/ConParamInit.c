...
/*	pAxis->controlObject.order=6;
	...
	pAxis->controlObject.pA[1] = -7.967;
	pAxis->controlObject.pA[2] = 25.65;
	pAxis->controlObject.pA[3] = -18.19;
	pAxis->controlObject.pA[4] = -3.969;
	pAxis->controlObject.pA[5] = 4.378;
	
	pAxis->controlObject.pB[0] = 0;
	pAxis->controlObject.pB[1] = 3.882;
	pAxis->controlObject.pB[2] = -5.776;
	pAxis->controlObject.pB[3] = 4.002;
	pAxis->controlObject.pB[4] = -1.2032;
	pAxis->controlObject.pB[5] = -0.09539;
*/
	...
	pAxis->controlObject.pUout = (double *)malloc(pAxis->controlObject.order*sizeof(double));
	pAxis->controlObject.pA[0] = 0;
	pAxis->controlObject.pA[1] = 2e-7;
	pAxis->controlObject.pA[2] = 2e-7;

	
	pAxis->controlObject.pB[0] = 0;
	pAxis->controlObject.pB[1] = 1;
